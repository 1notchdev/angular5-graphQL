...
export class AuthComponent implements OnInit {
    ...
    signin() {
        ...
        this._authService.login(this.model.email, this.model.password).subscribe(
            ...
            error => {
                ...
                this._alertService.error(error.message || "There is an error while handling your request");
                this.loading = false;
            });
    }
    ...
    signup() {
        this.loading = true;
        this._authService.createNewUser(this.model.email, this.model.password).subscribe(
            data => {
                this.showAlert('alertSignin');
            ...
            error => {
                ...
                this._alertService.error(error.message || "There are errors when processing your request");
                this.loading = false;
            });
    }
